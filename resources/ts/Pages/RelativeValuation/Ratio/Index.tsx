        ...
        <div className="hero min-h-[60vh] bg-base-300">
            <div className="hero-content flex-col w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 !w-full">
                    <InfoCard key={1} header={"Statistics"} subheader={props.ratioExplicitName} colSpan="col-span-1 lg:col-span-2">
                    ...
                    <InfoCard key={2} header={"History"} subheader={props.ratioExplicitName} colSpan="col-span-1 lg:col-span-3">
